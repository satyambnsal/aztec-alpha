...
export declare function serializeTransaction(transaction: CeloTransactionSerializable, signature?: Signature | undefined): `0x02${string}` | `0x01${string}` | `0x03${string}` | import("../../index.js").TransactionSerializedLegacy | `0x7c${string}` | `0x7b${string}`;
