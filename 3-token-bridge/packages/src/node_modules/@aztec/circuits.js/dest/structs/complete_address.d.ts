...
export declare class CompleteAddress {
    ...
    static create(address: AztecAddress, publicKey: PublicKey, partialAddress: PartialAddress): CompleteAddress;
    ...
    static fromPublicKeyAndInstance(publicKey: PublicKey, instance: Parameters<typeof computePartialAddress>[0]): CompleteAddress;
