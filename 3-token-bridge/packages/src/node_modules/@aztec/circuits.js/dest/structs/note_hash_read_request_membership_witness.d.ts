 ...
 */
export declare class NoteHashReadRequestMembershipWitness {
    /**
    ...
    hintToNoteHash: Fr);
    toBuffer(): Buffer;
    static mock(size: number, start: number): NoteHashReadRequestMembershipWitness;
    /**
     * Creates a random membership witness. Used for testing purposes.
     * @returns Random membership witness.
     */
    static random(): NoteHashReadRequestMembershipWitness;
    /**
     ...
     */
    static empty(leafIndex: bigint): NoteHashReadRequestMembershipWitness;
    /**
     * Creates a transient read request membership witness.
     * @returns an empty transient read request membership witness.
     */
    static emptyTransient(): NoteHashReadRequestMembershipWitness;
    static fromBufferArray(leafIndex: Fr, siblingPath: Tuple<Buffer, typeof NOTE_HASH_TREE_HEIGHT>, isTransient: boolean, hintToNoteHash: Fr): NoteHashReadRequestMembershipWitness;
    static fromMembershipWitness(membershipWitness: MembershipWitness<typeof NOTE_HASH_TREE_HEIGHT>, isTransient: boolean, hintToNoteHash: Fr): NoteHashReadRequestMembershipWitness;
    /**
...
//# sourceMappingURL=note_hash_read_request_membership_witness.d.ts.map