...
export type CircuitSimulationStats = {
    ...
    /** Name of the circuit. */
    circuitName: 'base-parity' | 'root-parity' | 'base-rollup' | 'private-kernel-init' | 'private-kernel-ordering' | 'root-rollup' | 'merge-rollup' | 'private-kernel-inner' | 'public-kernel-setup' | 'public-kernel-app-logic' | 'public-kernel-teardown' | 'public-kernel-tail';
    /** Duration in ms. */
    duration: number;
...
export type Stats = L1PublishStats | NodeSyncedChainHistoryStats | CircuitSimulationStats | L2BlockBuiltStats | L2BlockHandledStats | NoteProcessorCaughtUpStats | TxAddedToPoolStats | TxPXEProcessingStats | TxSequencerProcessingStats | TreeInsertionStats;
