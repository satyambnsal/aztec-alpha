import { ABIParameter, ABIParameterVisibility, ABIType, DebugFileMap, DebugInfo, EventAbi } from '@aztec/foundation/abi';
export declare const AZTEC_PRIVATE_ATTRIBUTE = "aztec(private)";
export declare const AZTEC_PUBLIC_ATTRIBUTE = "aztec(public)";
export declare const AZTEC_PUBLIC_VM_ATTRIBUTE = "aztec(public-vm)";
export declare const AZTEC_INTERNAL_ATTRIBUTE = "aztec(internal)";
export declare const AZTEC_INITIALIZER_ATTRIBUTE = "aztec(initializer)";
/** The witness indices of the parameters. */
type ParamWitnessIndices = {
    start: number; /** End */
    end: number;
};
...
export interface NoirFunctionAbi {
    ...
    param_witnesses: {
        [key: string]: undefined | ParamWitnessIndices[];
    };
