...
export declare class BarretenbergApi {
    ...
    poseidonHash(inputsBuffer: Fr[]): Promise<Fr>;
    poseidonHashes(inputsBuffer: Fr[]): Promise<Fr>;
    ...
    acirNewGoblinAcirComposer(): Promise<Ptr>;
    ...
    acirProveAndVerifyGoblinUltraHonk(constraintSystemBuf: Uint8Array, witnessBuf: Uint8Array): Promise<boolean>;
    acirGoblinProve(acirComposerPtr: Ptr, constraintSystemBuf: Uint8Array, witnessBuf: Uint8Array): Promise<Uint8Array>;
    ...
    acirGoblinVerify(acirComposerPtr: Ptr, proofBuf: Uint8Array): Promise<boolean>;
