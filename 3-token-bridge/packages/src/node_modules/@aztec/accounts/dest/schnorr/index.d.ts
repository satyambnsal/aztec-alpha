...
import { AccountWallet } from '@aztec/aztec.js/wallet';
 ...
 */
export declare function getSchnorrWallet(pxe: PXE, address: AztecAddress, signingPrivateKey: GrumpkinPrivateKey): Promise<AccountWallet>;
