...
import SchnorrHardcodedAccountContractArtifactJson from '../artifacts/schnorr_hardcoded_account_contract-SchnorrHardcodedAccount.json' assert { type: 'json' };
...
export class SchnorrHardcodedAccountContract extends ContractBase {
   ...
   */
  public static deployWithOpts<M extends keyof SchnorrHardcodedAccountContract['methods']>(
    opts: { publicKey?: PublicKey; method?: M; wallet: Wallet },
    ...args: Parameters<SchnorrHardcodedAccountContract['methods'][M]>
  ) {
    return new DeployMethod<SchnorrHardcodedAccountContract>(
