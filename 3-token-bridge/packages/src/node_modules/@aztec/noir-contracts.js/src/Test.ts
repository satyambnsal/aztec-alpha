...
export class TestContract extends ContractBase {
  ...
  public methods!: {
    /** consume_message_from_arbitrary_sender_public(content: field, secret: field, sender: struct) */
    ...
    assert_private_global_vars: ((chain_id: FieldLike, version: FieldLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;
    ...
    /** consume_mint_private_message(secret_hash_for_redeeming_minted_notes: field, amount: field, secret_for_L1_to_L2_message_consumption: field) */
    ...
    assert_public_global_vars: ((
      chain_id: FieldLike,
      version: FieldLike,
      block_number: FieldLike,
      timestamp: FieldLike,
    ...
    /** consume_mint_public_message(to: struct, amount: field, secret: field) */
