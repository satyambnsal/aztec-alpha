...
export declare class SchnorrAccountContract extends ContractBase {
     ...
     */
    static deployWithOpts<M extends keyof SchnorrAccountContract['methods']>(opts: {
        publicKey?: PublicKey;
        method?: M;
        wallet: Wallet;
    }, ...args: Parameters<SchnorrAccountContract['methods'][M]>): DeployMethod<SchnorrAccountContract>;
    /**
