...
export declare class StatefulTestContract extends ContractBase {
    ...
    methods: {
        ...
        /** create_note_no_init_check(owner: struct, value: field) */
        create_note_no_init_check: ((owner: AztecAddressLike, value: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        ...
        /** public_constructor(owner: struct, value: field) */
        public_constructor: ((owner: AztecAddressLike, value: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    };
}
